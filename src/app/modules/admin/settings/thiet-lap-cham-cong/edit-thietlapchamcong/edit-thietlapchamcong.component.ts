...
@Component({
  selector: 'app-edit-thietlapchamcong',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
    MatSlideToggleModule
  ],
  templateUrl: './edit-thietlapchamcong.component.html'
})
export class EditThietLapChamCongComponent {
  ...
  // save data
  save(): void {
    this._trangthaichamcongService.update(this.data.id, this.editDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
