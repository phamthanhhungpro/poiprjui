...
@Component({
  selector: 'app-edit-linhvuc',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './edit-linhvuc.component.html'
})
export class EditLinhVucComponent {
  ...
  // save data
  save(): void {
    this._linhvucService.update(this.data.id, this.editDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
