...
@Component({
  selector: 'app-create-linhvuc',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './create-linhvuc.component.html'
})
export class CreateLinhVucComponent {
  ...
  // save data
  save(): void {
    this._linhvucService.create(this.addDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
