...
import { CreateLinhVucComponent } from './create-linhvuc/create-linhvuc.component';
import { EditLinhVucComponent } from './edit-linhvuc/edit-linhvuc.component';
...
@Component({
  ...
  imports: [MatIconModule, RouterLink, MatButtonModule, CdkScrollable, NgIf,
    ...
    FuseDrawerComponent, MatDividerModule, MatSidenavModule, CreateLinhVucComponent,
    EditLinhVucComponent, CommonModule],
...
export class LinhVucComponent {
  ...
  delData(role: any) {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result === 'confirmed') {
        this._LinhVucService.delete(role.id).subscribe(() => {
          this.getTableData();
        });
      }
    });
  ...
  // get data from api
  getTableData() {
    this.data$ = this._LinhVucService.getAllNoPaging().pipe(
      map((data: any) => {
