...
@Component({
  selector: 'app-edit-donvi',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './edit-donvi.component.html'
})
export class EditDonviComponent {
  ...
  // save data
  save(): void {
    this._coquandonviService.update(this.data.id, this.editDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
