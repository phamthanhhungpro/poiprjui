...
@Component({
  selector: 'app-create-donvi',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './create-donvi.component.html'
})
export class CreateDonviComponent {
  ...
  // save data
  save(): void {
    this._coquandonviService.create(this.addDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
