...
@Component({
  selector: 'app-create-congthucluong',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './create-congthucluong.component.html'
})
export class CreateCongThucLuongComponent {
  ...
  // save data
  save(): void {
    this._congthucluongService.create(this.addDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
