...
@Component({
  selector: 'app-create-thamsoluong',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './create-thamsoluong.component.html'
})
export class CreateThamSoLuongComponent {
  ...
  // save data
  save(): void {
    this._thamsoluongService.create(this.addDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
