...
@Component({
  selector: 'app-create-vitricongviec',
  standalone: true,
  imports: [MatButtonModule, MatIconModule, NgIf, NgFor, MatDividerModule,
    FormsModule, MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatFormFieldModule,
  ],
  templateUrl: './create-vitricongviec.component.html'
})
export class CreateViTriCongViecComponent {
  ...
  // save data
  save(): void {
    this._vitricongviecService.create(this.addDataForm.value).subscribe(res => {
      if (res.isSucceeded) {
