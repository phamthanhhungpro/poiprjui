...
const baseUrl = environment.prjApiUrl + 'DuAnSetting';

@Injectable({
  providedIn: 'root'
})

export class DuAnSettingService {
  ...
  updateAllSetting(data: any): Observable<any> {
    return this.http.put(`${baseUrl}/UpdateAllSetting`, data);
  }
}
